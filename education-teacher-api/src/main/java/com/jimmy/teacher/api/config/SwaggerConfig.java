...
public class SwaggerConfig extends WebConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("测试样例").select()
                ...
                .apis(RequestHandlerSelectors.basePackage("com.jimmy")).paths(PathSelectors.any())//controller所在的位置
                .build()
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(authorInterceptor).addPathPatterns("/restart/**");
    }
